...
// PHP 8 removed ZEND_ACC_DTOR (destructors are recognized by name).
// The bit value reused for ZEND_ACC_VARIADIC, so define this as a no-op
// to keep older callsites compiling without setting a wrong flag.
