...
// Reading a Decimal with scale > 38 (Decimal256 range) must throw a
...
// A throwing __toString() on an insert cell must surface the original
...
// A reference inside a nested array element derefs instead of throwing
...
// Float into DateTime64(9) is rejected (lossy); int ticks work.
...
// IPv4 accepts an integral float (consistent with integer columns);
